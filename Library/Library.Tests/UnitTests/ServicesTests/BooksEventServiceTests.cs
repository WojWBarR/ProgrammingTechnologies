...
namespace Library.LogicTests
{
    public class BooksEventServiceTests
    {
        public BooksEventServiceTests()
        {
            ...
            _mockRentalSet.As<IQueryable<RentalEvent>>().Setup(m => m.GetEnumerator())
                .Returns(_rentalEvents.GetEnumerator());
            ...
            _mockReturnSet.As<IQueryable<ReturnEvent>>().Setup(m => m.GetEnumerator())
                .Returns(_returnEvents.GetEnumerator());
